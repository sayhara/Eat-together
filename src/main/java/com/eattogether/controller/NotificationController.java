...
import com.eattogether.service.NotificationService;
...
public class NotificationController {
    ...
    public String getNotifications(@AuthUser Account account, Model model){
    ...
    public String getOldNotifications(@AuthUser Account account, Model model){
        List<Notification> notifications = repository.
    ...
    public String deleteNotifications(@AuthUser Account account){
    ...
    private void putCategorizedNotifications(Model model, List<Notification> notifications,
        ...
        for (var notification:notifications){
            switch (notification.getNotificationType()){
                ...
                case STUDY_CREATED:
                    newStudyNotifications.add(notification); break;
                case EVENT_ENROLLMENT:
                    eventEnrollmentNotifications.add(notification); break;
                case STUDY_UPDATED:
                    watchingStudyNotifications.add(notification); break;
            }
        }
